...
//                mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(userLocation, 15));
                ...
                double lat = Double.parseDouble(bundle.getString("lat")); // Ambil latitude
                double lng = Double.parseDouble(bundle.getString("lng")); // Ambil longitude

                LatLng locationuser = new LatLng(lat, lng); // Konversi ke LatLng

                // Contoh: Pindahkan kamera ke titik koordinat di Google Maps
                if (mMap != null) {
                    mMap.addMarker(new MarkerOptions().position(locationuser).title("Lokasi User"));
